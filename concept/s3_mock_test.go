...
func (s *mockS3Client) GetConceptAndTransactionID(ctx context.Context, UUID string) (bool, ontology.OldConcept, string, error) {
	if s.callsMocked {
		s.Called(UUID)
	}
	...
	return false, ontology.OldConcept{}, "", s.err
}
