...
type Client interface {
	GetConceptAndTransactionID(ctx context.Context, UUID string) (bool, ontology.OldConcept, string, error)
...
func (c *ConceptClient) GetConceptAndTransactionID(ctx context.Context, UUID string) (bool, ontology.OldConcept, string, error) {
	...
	var concept ontology.OldConcept
	if err = json.NewDecoder(resp.Body).Decode(&concept); err != nil {
		...
		return true, ontology.OldConcept{}, "", err
	}
