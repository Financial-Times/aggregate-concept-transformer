...
type Client interface {
	GetConceptAndTransactionID(ctx context.Context, UUID string) (bool, ontology.Concept, string, error)
...
func (c *ConceptClient) GetConceptAndTransactionID(ctx context.Context, UUID string) (bool, ontology.Concept, string, error) {
	...
	if err = json.NewDecoder(resp.Body).Decode(&concept); err != nil {
		...
		return true, ontology.Concept{}, "", err
	}
